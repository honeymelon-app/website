...
const faqs = [
    ...
    },
    {
        ...
        answer: 'Your license covers all v1.x updates. When v2.0 is released, existing customers will be offered a discounted upgrade. You can continue using v1.x indefinitely.',
    },
    {
